...
{
    public abstract class EfCoreFeedbackRepositoryBase : EfCoreRepository<AngularPocDbContext, Feedback, Guid>
    {
        public EfCoreFeedbackRepositoryBase(IDbContextProvider<AngularPocDbContext> dbContextProvider)
