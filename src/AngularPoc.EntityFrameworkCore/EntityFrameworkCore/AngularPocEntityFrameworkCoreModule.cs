...
public class AngularPocEntityFrameworkCoreModule : AbpModule
{
    ...
    {
        context.Services.AddAbpDbContext<AngularPocDbContext>(options =>
        {
        ...
        Configure<AbpDbContextOptions>(options =>
        {
             ...
             * See also AngularPocDbContextFactory for EF Core tooling. */
            options.UseNpgsql();
        });
